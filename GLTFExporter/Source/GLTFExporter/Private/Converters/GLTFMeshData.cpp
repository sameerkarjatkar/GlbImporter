...
#endif
{
	...
	else
	{
		...
		//UDatasmithAssetUserData* pAssetUserData = UDatasmithAssetUserData::GetDatasmithUserData(const_cast<UStaticMesh*>(StaticMesh));
		//if (!pAssetUserData)
		//{
		...
		//else
		//{
		//	Extradata = pAssetUserData->MetaData;
		//}
...
#endif
{
	...
	else
	{
		...
		if (UWorld* World = GEditor->GetEditorWorldContext().World())
		{
			...
			if (AActor* Actor = World->
				SpawnActor<AActor>(SpawnParams))
			{
