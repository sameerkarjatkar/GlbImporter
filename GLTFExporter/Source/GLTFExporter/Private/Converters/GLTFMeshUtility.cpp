...
TMap<FName, FString>* FGLTFMeshUtility::GetMetadata(const UStaticMesh* StaticMesh)
{
	TMap<FName, FString>* pMetadataObj = nullptr;
	if (StaticMesh)
	{
		pMetadataObj = UMetaData::GetMapForObject(StaticMesh);
	}
	return 	pMetadataObj;
}
