...
template<> EXTRASCUSTOMPROPERTY_API UScriptStruct* StaticStruct<FExtraCustomProperty>()
{
	...
	struct Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_677558384(TEXT("/Script/ExtrasCustomProperty"),
		Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_TF_GLTFCustom_Plugins_ExtrasCustomProperty_Source_ExtrasCustomProperty_Public_CustomProperty_h_Statics::ScriptStructInfo),
		nullptr, 0);
