...
namespace GLTF
{
	struct TFGLTFCORE_API FTextureTransform
	{
		float Offset[2];
		float Rotation;
		float Scale[2];
	...
	struct TFGLTFCORE_API FTextureMap
	{
		int32 TextureIndex;
		uint8 TexCoord;
	...
	struct TFGLTFCORE_API FMaterial
	{
		...
		struct  FExtras
		{
			...
			TMap<FString, TSharedPtr<FJsonObject>> ExtrasInfosMap;
		};
		...
		TSharedPtr<FJsonObject> ExtraProperty;
