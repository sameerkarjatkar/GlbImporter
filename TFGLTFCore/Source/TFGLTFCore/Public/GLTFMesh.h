...
namespace GLTF
{
	...
	struct TFGLTFCORE_API FTriangle
	{
		uint32 A, B, C;
	...
	struct TFGLTFCORE_API FJointInfluence
	{
		FVector4 Weight;
		uint16   ID[4];
	...
	struct TFGLTFCORE_API FVariantMapping
	{
		int32 MaterialIndex;
	...
	struct TFGLTFCORE_API FPrimitive
	{
		enum class EMode
		{
