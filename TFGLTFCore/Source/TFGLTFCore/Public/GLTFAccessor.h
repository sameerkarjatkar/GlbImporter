...
namespace GLTF
{
	...
	struct TFGLTFCORE_API FBufferView
	{
	...
	struct TFGLTFCORE_API FAccessor
	{
	...
	struct TFGLTFCORE_API FValidAccessor final : FAccessor
	{
	...
	struct TFGLTFCORE_API FVoidAccessor final : FAccessor
	{
		FVoidAccessor()
