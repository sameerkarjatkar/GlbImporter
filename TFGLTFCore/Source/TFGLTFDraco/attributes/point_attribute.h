...
#include "TFGLTFDraco/attributes/attribute_transform_data.h"
...
#ifdef DRACO_POINTATTRIBUTE_EXPORTS
#define DRACO_POINTATTRIBUTE_API __declspec(dllexport)
#else
#define DRACO_POINTATTRIBUTE_API __declspec(dllimport)
#endif
...
// value ids.
class DRACO_POINTATTRIBUTE_API PointAttribute : public GeometryAttribute {
 public:
  PointAttribute();
