...
#include "TFGLTFDraco/core/bounding_box.h"
#include "TFGLTFDraco/core/vector_d.h"
#include "TFGLTFDraco/draco_features.h"
#include "TFGLTFDraco/metadata/geometry_metadata.h"

#ifdef DRACO_POINTCLOUD_EXPORTS
#define DRACO_POINTCLOUD_API __declspec(dllexport)
#else
#define DRACO_POINTCLOUD_API __declspec(dllimport)
#endif
...
class DRACO_POINTCLOUD_API PointCloud {
 public:
  PointCloud();
