...
#include "TFGLTFDraco/compression/attributes/sequential_normal_attribute_encoder.h"
#endif
#include "TFGLTFDraco/compression/attributes/sequential_quantization_attribute_encoder.h"
