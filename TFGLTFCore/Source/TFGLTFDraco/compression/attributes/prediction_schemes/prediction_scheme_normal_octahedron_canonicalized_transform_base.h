...
#include "TFGLTFDraco/compression/attributes/normal_compression_utils.h"
#include "TFGLTFDraco/compression/attributes/prediction_schemes/prediction_scheme_normal_octahedron_transform_base.h"
