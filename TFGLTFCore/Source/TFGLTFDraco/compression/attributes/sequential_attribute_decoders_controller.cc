...
#include "TFGLTFDraco/compression/attributes/sequential_normal_attribute_decoder.h"
#endif
#include "TFGLTFDraco/compression/attributes/sequential_quantization_attribute_decoder.h"
