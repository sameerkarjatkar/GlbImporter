...
#include "TFGLTFDraco/compression/config/decoder_options.h"
...
#ifdef DRACO_DECODER_EXPORTS
#define DRACO_DECODER_API __declspec(dllexport)
#else
#define DRACO_DECODER_API __declspec(dllimport)
#endif
...
class DRACO_DECODER_API Decoder {
 public:
