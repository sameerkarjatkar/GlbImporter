...
#ifdef DRACO_DECODEBUFFER_EXPORTS
#define DRACO_DECODEBUFFER_API __declspec(dllexport)
#else
#define DRACO_DECODEBUFFER_API __declspec(dllimport)
#endif
...
class DRACO_DECODEBUFFER_API DecoderBuffer {
 public:
  DecoderBuffer();
  ...
  class DRACO_DECODEBUFFER_API BitDecoder {
  public:
      BitDecoder();
      ~BitDecoder();
