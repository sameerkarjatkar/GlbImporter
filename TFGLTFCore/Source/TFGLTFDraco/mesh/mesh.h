...
#include "TFGLTFDraco/attributes/geometry_indices.h"
#include "TFGLTFDraco/core/hash_utils.h"
#include "TFGLTFDraco/core/macros.h"
...
#include "TFGLTFDraco/mesh/mesh_indices.h"
#include "TFGLTFDraco/metadata/structural_metadata.h"
#endif
#include "TFGLTFDraco/point_cloud/point_cloud.h"
...
#ifdef DRACO_MESH_EXPORTS
#define DRACO_MESH_API __declspec(dllexport)
#else
#define DRACO_MESH_API __declspec(dllimport)
#endif
...
class DRACO_MESH_API Mesh : public PointCloud {
 public:
